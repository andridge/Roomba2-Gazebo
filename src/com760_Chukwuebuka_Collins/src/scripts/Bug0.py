...
def main():
    ...
    # Wait for thirty seconds before initializing the services
    rospy.loginfo("Waiting for thirty seconds before initializing services.")
    rospy.sleep(30)  # Sleep for thirty seconds
